...
<body>
  ...
  <page size="dipakai" layout="landscape">
    ...
    <form action="#" method="post" class="">
      <span id="remove">
        <a class="btn btn-success" type="submit" name="ubah_status"><span class="icon-print"></span> CETAK</a>
</form>   
      </span>
    </div>
    <?php
    ...
    ?>
      <center>
        <h4>
          RESTAURANT ES CENDOL
        </h4>
        <span>
        Jl. Dipati Ukur No.112-116, Lebakgede, Kecamatan Coblong,<br> Kota Bandung, Jawa Barat 40132.<br>
            ...
            <hr>
              <table style="width: 100%">
                <tr>
                  ...
                  <td>
                    <?php echo $result_order['username'];?>
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <?php echo $result_order['id_order'];?>
                  </td>
                </tr>
                <tr>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <?php echo $result_order['status_order'];?>
                  </td>
                </tr>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <?php
                    ...
                    $result_harga = mysqli_fetch_array($sql_harga);
                      ...
                      if (isset($_POST['ubah_status'])) {
                        ...
                        $query_ubah_status = "UPDATE tb_dapur SET status_masakan = 'sudah dimasak' WHERE id_order = $id_order AND status_masakan = 'belum dimasak'";
                      
                        if ($result_ubah_status) {
                          echo "Status masakan telah diubah menjadi sudah dimasak.";
                      } else {
                          echo "Gagal mengubah status masakan: " . mysqli_error($conn);
                      }
                  ?>
                  ...
                  <tr>
                    <td></td>
                    <td><strong><center>Tunai</center></strong></td>
                    <td class="right"></td>
                    <td class="right"></td>
  ...
  <tr>
    ...
    <td><center><b>Email :</b> m.andre.10121072@mahasiswa.unikom.ac.id</center></td>
    <td><b>Telp :</b> +62 812-6193-3352</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
