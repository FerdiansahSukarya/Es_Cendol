          ...
          <div class="widget-content nopadding" >
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                ...
                ?>
                <tr>
                  <td><center><?php echo $r_order['nama_user'];?></center></td>
                  <td class="right"><center>Rp. <?php echo $r_order['total_harga'];?>,-</center></td>
                  <td>
                    <form action="" method="post">
                     <center><button type="submit" value="<?php echo $r_order['id_order'];?>" name="edit_order" class="btn btn-success btn-mini">
                      <i class='icon-pencil'></i>&nbsp;&nbsp;Transaksi &nbsp;&nbsp;</button>
                      <button type="submit" value="<?php echo $r_order['id_order'];?>" name="hapus_order" class="btn btn-mini btn-danger">
                      <i class='icon icon-trash'></i>&nbsp; Hapus</button></center>
                    </form>
                  </td>
                </tr>
                <?php
                ...
                <tr>
                  ...
                  <td>
                    <form action="" method="post">
                      ...
                      <a target='_blank' href="cetak_transaksi_sesudah.php?konten=<?php echo $r_sudah_order['id_order'];?>" class="btn btn-mini btn-success">
