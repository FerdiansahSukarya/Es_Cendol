...
<!--Header-part-->
<div id="header">
  <h1><a href="cek_pemesanan.php">Cek Pesanan</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="sidebar"><a href="entri_referensi.php" class="visible-phone"><i class="icon icon-inbox"></i> <span>Entri Transaksi</span></a>
  ...
  ?>
    <li> <a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
    <li class="active"> <a href="cek_pemesanan.php"><i class="icon icon-inbox"></i> <span>Cek Pesanan</span></a> </li>
    <li> <a href="logout.php"><i class="icon icon-sign-out"></i> <span>Logout</span></a> </li>
  <?php
  ...
  ?>
    <li> <a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
    <li> <a href="referensi.php"><i class="icon icon-tasks"></i> <span>Entri Referensi</span></a> </li>
    <li class="active"> <a href="cek_makan.php"><i class="icon icon-inbox"></i> <span>Cek Pesanan</span></a> </li>
    <li> <a href="logout.php"><i class="icon icon-sign-out"></i> <span>Logout</span></a> </li>
  <?php
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="cek_pemesanan.php" title="Go to here" class="tip-bottom"><i class="icon icon-inbox"></i> Cek Pesanan</a></div>
  </div>
<!--End-breadcrumbs-->
            ...
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><center><?php echo $r_sudah_order['id_order'];?></center></td>
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  <td><center><?php echo $nomor++; ?>. </center></td>
                  <td><center><?php echo $r_sudah_order['id_order'];?></center></td>
                  <td><center><?php echo $r_sudah_order['nama_user'];?></center></td>
