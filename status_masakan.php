  ...
  <div class="container-fluid">
    ...
    <?php
      if($r['id_level'] == 1 || $r['id_level'] == 4){
        ...
        $query_pemesan = "select * from tb_order left join tb_user on tb_order.id_pengunjung = tb_user.id_user where id_order = $id";
      ...
      <div class="span7">
        <div class="widget-box">
          <div class="widget-title bg_lg"><span class="icon"><i class="icon-th-large"></i></span>
            <h5>Transaksi Pembayaran ( Meja No. <?php echo $result_pemesan['nama_user'];?>)</h5>
          </div>
            ...
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                ...
                <?php
                  ...
                  $query_harga = "select * from tb_order where id_pengunjung = $id_pemesan and status_order = 'sudah bayar'";
          ...
          <div class="widget-content nopadding" >
            <form action="#" method="post" class="form-horizontal">
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" id="" name="" class="span11" placeholder="" onchange="return operasi()"/>
                </div>
              </div>
