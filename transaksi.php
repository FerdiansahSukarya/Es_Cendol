    ...
    ?>
      ...
      <?php
          ...
          if(isset($_REQUEST['save_order'])){
            ...
            $belum_dimasak = 'belum dimasak';
            
            

            $query_save_transaksi = "update tb_order set id_admin = $id, uang_bayar = $uang_bayar, uang_kembali = $uang_kembali, status_order = 'sudah bayar', status_masakan = '$belum_dimasak' where id_order = $id_order";
            ...
            $query_simpan_order = "insert into tb_dapur values('$id_order', '$belum_dimasak')";
