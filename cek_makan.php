...
<!--Header-part-->
<div id="header">
  <h1><a href="cek_makan.php">Cek Pesanan</a></h1>
</div>
<!--close-Header-part--> 
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="cek_makan.php" title="Go to here" class="tip-bottom"><i class="icon icon-inbox"></i> Cek Pesanan</a></div>
  </div>
<!--End-breadcrumbs-->
            ...
            <table class="table table-bordered table-invoice-full">
              <thead>
                <tr>
                  ...
                  <th class="head0 right">No Order</th>
              ...
              <tbody>
                <tr>
                  ...
                  <form method="post" action="#">
                    ...
                    <input type="number" name="id_order" id="id_order" required>
                    <input type="submit" name="ubah_status" value="selesai"></label>
                  </form>
                  </td>
                </tr>
              </tbody>
