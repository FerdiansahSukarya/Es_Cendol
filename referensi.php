...
<!--Header-part-->
<div id="header">
  <h1><a href="referensi.php">Entri Referensi</a></h1>
</div>
<!--close-Header-part--> 
...
<!--sidebar-menu-->
<div id="sidebar"><a href="referensi.php" class="visible-phone"><i class="icon icon-tasks"></i> <span>Entri Referensi</span></a>
  <ul>
    <?php
    if($r['id_level'] == 1){
  ?>
    <li><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
    <li class="active"> <a href="referensi.php"><i class="icon icon-tasks"></i> <span>Entri Referensi</span></a> </li>
  ...
  ?>
    <li> <a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
    <li class="active"> <a href="referensi.php"><i class="icon icon-tasks"></i> <span>Entri Referensi</span></a> </li>
    <li> <a href="cek_makan.php"><i class="icon icon-inbox"></i> <span>Cek Pesanan</span></a> </li>
    <li> <a href="logout.php"><i class="icon icon-sign-out"></i> <span>Logout</span></a> </li>
  <?php
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="referensi.php" title="Go to here" class="tip-bottom"><i class="icon icon-tasks"></i> Entri Referensi</a></div>
  </div>
<!--End-breadcrumbs-->
