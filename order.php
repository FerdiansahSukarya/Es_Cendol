        ...
        <div class="widget-box span12">
          ...
          <div class="widget-content nopadding" >
            ...
            <form action="#" method="post" class="form-horizontal">
              ...
              <p></p>
              <center>
              <a target='_blank' href="cetak_transaksi_sebelum.php?konten=<?php echo $r_sudah_order['id_order'];?>" class="btn btn-mini btn-success">
                        <i class='icon icon-print'></i>
                  &nbsp;&nbsp;Struk&nbsp;&nbsp;</a>
                </button>
                <button type="submit" name="refresh_page" class="btn btn-mini btn-info">
                <i class='icon-share'></i>
                  &nbsp;&nbsp;Kembali&nbsp;&nbsp;
                </button>
                <?php
                if (isset($_REQUEST['refresh_page'])) {
                  $id_order = $_REQUEST['refresh_page'];
    
    // Contoh: Pemeriksaan pembayaran
    $query_check_payment = "SELECT status_order FROM tb_order WHERE id_order = $id";
    $result_check_payment = mysqli_query($conn, $query_check_payment);
    $row = mysqli_fetch_assoc($result_check_payment);
    ...
    <div class="row-fluid">
                  ...
                  ?>
                    ...
                    <?php
                      ...
                      if(isset($_REQUEST['tambah_pesan'])){
                        ...
                        $query_lihat_pesannya = "select * from tb_pesan order by id_pesan desc limit 5";
            ...
            <table class="table table-bordered table-striped">
              ...
              ?>
                <tr class="odd gradeX">
                  ...
                  <td>
                    <form action="" method="post">
                      <button type="submit" value="<?php echo $r_draft_pesan['id_pesan'];?>" name="hapus_pesan1" class="btn btn-danger btn-mini">
              ...
              <?php
              if(isset($_POST['hapus_pesan1'])){
                $id_pesan = $_POST['hapus_pesan1'];
      ...
      <?php
          ...
          if(isset($_POST['edit_pesan'])){
            $id_pesan = $_POST['edit_pesan'];
            $query_dit_pesan = "edit from tb_pesan where id_pesan = $id_pesan";
            $sql_dit_pesan = mysqli_query($conn, $query_edit_pesan);
          ...
          if(isset($_POST['proses_pesan'])){
            ...
            $status_masakan = 'belum jadi';

            date_default_timezone_set('Asia/Jakarta');
            $time = Date('YmdHis');
            echo $time;
            $query_simpan_order = "insert into tb_order values('', '$id_admin', '$id_pengunjung', $time, '$total_harga', '$uang_bayar', '$uang_kembali', '$status_order', '$status_masakan')";
